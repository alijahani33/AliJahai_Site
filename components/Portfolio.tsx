...
const dict = {
  en: {
    ...
    title: "Assistant IT Director & Hybrid Expert",
    ...
    contact_nav: "Contact",
    about_pitch: "A dual-faceted systems expert bridging enterprise network security (STP/RSTP, CCNA/CCNP, Zabbix monitoring) and modern software architectures (Next.js, FastAPI, Docker, Deep Learning). I design high-uptime network topologies and build scalable automation engines to digitize complex organizational workflows.",
    ...
    audience_desc: "Filter statistics and operational metrics by your profile:",
    enterprises: "Enterprises",
    startups: "Startups",
    tech_peers: "Tech Peers",
    enterprises_desc: "Ensuring 99.9% uptime for mission-critical petrochemical networks. Securing infrastructure through hardware upgrades, VLAN isolation, port security, and syslog alerts.",
    startups_desc: "Building scalable on-premises software architectures (FastAPI, React, Docker). Designing visual workflow modelers and ticketing platforms to automate pipelines.",
    tech_peers_desc: "M.Sc. research in remote sensing deep learning. Developed real-time CNN defect detection models running at 400 FPS with 99% accuracy.",
    skills_title: "Technical Stack",
    exp_title: "Professional Experience",
    edu_title: "Education",
    contact_title: "Let's Build Something Secure",
  ...
  fa: {
    ...
    about_pitch: "متخصص دووجهی در امنیت شبکه و زیرساخت پتروشیمی و مهندسی سیستم‌های نرم‌افزاری هوشمند. تخصص در معماری‌های شبکه با لود بالا و توسعه سامانه‌های فرم‌ساز و هوش مصنوعی صنعتی.",
    about_p1: "من در تامین پایداری و امنیت بستر ارتباطی صنایع بزرگ فعالیت می‌کنم. در شرکت دماوند انرژی عسلویه، به عیب‌یابی پیچیده‌ترین مشکلات شبکه (از جمله حل معضل لوپ‌های یک‌ساله پخش) و راه‌اندازی مانیتورینگ پیشگیرانه پرداختم. همزمان، سامانه‌های بومی فرم‌ساز و موتورهای گردش‌کار سازمانی مبتنی بر هوش مصنوعی را توسعه می‌دهم.",
    choose_path: "مسیر خود را انتخاب کنید",
    audience_desc: "متریک‌ها و توانمندی‌ها را متناسب با مشخصات خود فیلتر کنید:",
    enterprises: "سازمان‌های بزرگ",
    startups: "استارتاپ‌ها",
    tech_peers: "همکاران فنی",
    enterprises_desc: "تضمین پایداری ۹۹.۹ درصدی شبکه‌های حساس صنعتی پتروشیمی. سخت‌سازی زیرساخت سوئیچینگ، جداسازی پهنای باند و مانیتورینگ بلادرنگ با کاهش چشمگیر زمان خرابی.",
    startups_desc: "طراحی و توسعه سامانه‌های سازمانی خودمستقر با لود سریع. بهینه‌سازی کانتینرهای Docker و ایجاد اتوماسیون‌های سفارشی گردش‌کار جهت کاهش زمان ساخت فرم.",
    tech_peers_desc: "پژوهشگر ارشد هوش مصنوعی با معدل ۱۸.۵. توسعه‌دهنده مدل‌های یادگیری عمیق بینایی ماشین با سرعت پردازش تصویر ۴۰۰ فریم بر ثانیه در کارخانه‌های لوله‌سازی.",
